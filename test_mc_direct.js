...
async function testMastercardAPI() {
    ...
    try {
        ...
        const accountUrl = `${baseURL}/global-processing/core/accounts`;
        ...
        console.log('Response:', JSON.stringify(accountRes.data, null, 2));
        ...
        const cardUrl = `${baseURL}/global-processing/core/cards`;
        ...
        console.log('Response:', JSON.stringify(cardRes.data, null, 2));
