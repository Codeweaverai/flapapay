...
const members = [
    { name: 'Emma Wilson', role: 'Admin', status: 'Active', initials: 'E', color: 'from-[#ffd86a] to-[#f59a17]' },
    { name: 'Sarah Mukuka', role: 'Finance Manager', status: 'Active', initials: 'S', color: 'from-[#ffb34b] to-[#ef6c14]' },
                        ...
                        <div className="grid items-center gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:gap-16">
                            <div className="max-w-xl">
                                ...
                                <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                                    <Link to="/signup" className="group inline-flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#f8b51b] via-[#f59a17] to-[#ef6c14] px-6 py-3.5 text-sm font-extrabold text-[#17110a] shadow-[0_12px_34px_rgba(245,145,24,0.3)] transition hover:-translate-y-0.5 hover:from-[#ffc33d] hover:via-[#ff9f1f] hover:to-[#f57918]">
                                        Invite your team
                                ...
                                <div className="relative rounded-[2rem] border border-white/15 bg-white/[0.08] p-3 shadow-2xl backdrop-blur-xl">
                                    ...
                                    <div className="rounded-[1.4rem] bg-[#15120e] p-5 sm:p-7">
                                        <div className="flex items-start justify-between gap-4">
                                            ...
                                            <button type="button" aria-label="Add team member" className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-[#ffd86a] to-[#ef6c14] text-[#17110a] shadow-[0_8px_22px_rgba(245,145,24,0.25)]"><Plus className="h-5 w-5" /></button>
                                        </div>
