        ...
        <div className="min-h-screen bg-[#F9FAFB] font-sans selection:bg-purple-100">
            ...
            <main className="pt-20">
                ...
                <section className="relative overflow-hidden bg-white border-b border-gray-100 py-32">
                    ...
                    <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-gradient-to-tl from-blue-100/30 to-transparent rounded-full -mr-48 -mb-48 blur-3xl pointer-events-none"></div>
                    ...
                    <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
                        <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-50 border border-purple-100 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <span className="text-xs font-black text-purple-600 uppercase tracking-widest">Trust & Security</span>
                        </div>
                        <h1 className="text-5xl md:text-8xl font-black text-gray-900 mb-8 tracking-tight leading-tight">
                            Enterprise-Grade <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500">Security Infrastructure</span>
                        </h1>
                            ...
                            <div className="flex-1 max-w-4xl">
                                    ...
                                    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 mt-8">
                                            {[
                                                ...
                                                <div key={i} className="flex items-start gap-4 p-5 rounded-2xl bg-purple-50 border border-purple-100">
                                    ...
                                    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                                            {[
                                                ...
                                                <div key={i} className="text-center p-5 rounded-2xl bg-purple-50 border border-purple-100">
                                                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-purple-100 text-purple-600 mb-3">
                                                        {stat.icon}
                                                    </div>
                                    ...
                                    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            {[
                                                ...
                                                <div key={i} className="p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:border-purple-200 transition-all">
                                                    <div className="flex items-center justify-between mb-3">
                                                        <h3 className="text-lg font-black text-gray-900">{item.cert}</h3>
                                                        <span className={`px-3 py-1 rounded-full text-xs font-black ${item.status === 'Certified' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}`}>
                                                            {item.status}
                                                        </span>
                                                    </div>
                                ...
                                <section className="bg-gradient-to-br from-purple-600 to-blue-700 rounded-3xl p-12 text-center">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                        <a href="/contact" className="inline-flex items-center justify-center px-8 py-4 rounded-2xl bg-white text-purple-600 font-black hover:bg-purple-50 transition-all">
                                            Contact Security Team
                                        </a>
                                        <a href="/trust" className="inline-flex items-center justify-center px-8 py-4 rounded-2xl bg-purple-700 text-white font-black border border-purple-500 hover:bg-purple-600 transition-all">
                                            View Trust Center
                                        </a>
                                    </div>
                                </section>
