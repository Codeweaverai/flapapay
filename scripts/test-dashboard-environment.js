...
(async () => {
  ...
  console.log(JSON.stringify({ listStatus: listed.status, sandboxSelectionStatus: selectedSandbox.status, activityStatus: activity.status, liveSelectionStatus: selectedLive.status, liveBlockedByCompliance: shouldBlockLive }));
